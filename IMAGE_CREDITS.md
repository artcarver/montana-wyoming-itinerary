...
Day-header photos are sourced from Wikimedia Commons and resized/converted to
WebP. Attribution per the image licenses:

| File | Subject | Author | License | Source |
|------|---------|--------|---------|--------|
| `images/day1-lake-mcdonald.webp` | Reflection on Lake McDonald, Glacier NP | GlacierNPS | CC BY 2.0 | [Commons](https://commons.wikimedia.org/wiki/File:Reflection_on_Lake_McDonald_(7198413770).jpg) |
| `images/day2-avalanche-lake.webp` | Avalanche Lake, Glacier NP | Unknown | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Glacier_Avalanche_Lake.jpg) |
| `images/day3-going-to-the-sun.webp` | Going-to-the-Sun Road, Glacier NP | NPS / Tim Rains | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Going-to-the-Sun_Road.jpg) |
| `images/day4-many-glacier.webp` | Sunrise at Swiftcurrent Lake, Many Glacier | GlacierNPS | Public domain | [Commons](https://commons.wikimedia.org/wiki/File:Sunrise_at_Swiftcurrent_Lake_as_seen_from_the_Many_Glacier_Hotel_(48490111337).jpg) |
| `images/day5-mammoth.webp` | Upper Terraces, Mammoth Hot Springs | Brocken Inaglory | CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Upper_Terraces_of_Mammoth_Hot_Springs.jpg) |
